...
jQuery(document).ready(function () {
    ...
    jQuery(".newsletters-loader  .view-content").append('<div class="loader_wrap"><img src="' + windowpath + '/BOI/themes/boi_theme/images/loading.gif" class="img-responsive"></div>')
